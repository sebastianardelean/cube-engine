...
AppQt::AppQt(QWidget *parent) : QWidget(parent)
{
  ...
  // match
  connect(pushButton, &QPushButton::clicked, this, &AppQt::writeToDebug);
  ...
  connect(fatal, &QPushButton::clicked, this, &AppQt::close);// could just use close
};

void AppQt::writeToDebug(void)
{
