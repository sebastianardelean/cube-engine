...
struct MouseMotionEventMessage: public EventMessage {
    MouseMotionEventMessage(const int32_t posX,const int32_t posY):EventMessage(Event_MouseMotion){
	x=posX;
	y=posY;
    }
    int32_t x;
...
struct MouseButtonDownEventMessage: public EventMessage {
    MouseButtonDownEventMessage(const MouseButton b, const int32_t posX, const int32_t posY):EventMessage(Event_MouseButtonDown) {
	button = b;
	x = posX;
	y = posY;
    }
...
struct MouseButtonUpEventMessage: public EventMessage {
    MouseButtonUpEventMessage(const MouseButton b, const int32_t posX, const int32_t posY):EventMessage(Event_MouseButtonUp) {
	button = b;
	x = posX;
	y = posY;
    }
...
struct MouseWheelUpEventMessage: public EventMessage {
    MouseWheelUpEventMessage(const int32_t posY):EventMessage(Event_MouseWheelUp) {
	x = 0;
	y = posY;
    }
...
struct MouseWheelDownEventMessage: public EventMessage {
    MouseWheelDownEventMessage(const int32_t posY):EventMessage(Event_MouseWheelDown) {
	x = 0;
	y = posY;
    }
...
struct MouseWheelLeftEventMessage: public EventMessage {
    MouseWheelLeftEventMessage(const int32_t posX):EventMessage(Event_MouseWheelLeft) {
	x = posX;
	y = 0;
    }
...
struct MouseWheelRightEventMessage: public EventMessage {
    MouseWheelRightEventMessage(const int32_t posX):EventMessage(Event_MouseWheelRight) {
	x = posX;
	y = 0;
    }
