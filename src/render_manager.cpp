...
void RenderManager::Init(SDL_Window &window)
{
	...
	pTexture = SDL_CreateTexture(pRenderer,
		SDL_PIXELFORMAT_RGBA,
		SDL_TEXTUREACCESS_TARGET,
		nWindowWidth,
		nWindowHeight);
    }
    pSdlSurface = SDL_CreateRGBSrface(0,nWindowWidth,nWindowHeight,32,0,0,0,0);
}
...
void RenderManager::Render()
{
    ...
    SDL_UpdateTexture(pTexture, NULL,sprite.GetSurface()->pixels,sprite.GetSurface()->pitch);
